...
def buscar_solucion_DFS(estado_inicial, solucion):
    ...
    while (not solucionado) and len(nodos_frontera) != 0:
        ...
        if nodo.get_datos() == solucion:
            ...
            #Operador izquierdo
            hijo = [dato_nodo[1], dato_nodo[0], dato_nodo[2], dato_nodo[3], dato_nodo[4], dato_nodo[5], dato_nodo[6]]
            hijo_izquierdo = Nodo(hijo)
            if not hijo_izquierdo.en_lista(nodos_visitados) \
                and not hijo_izquierdo.en_lista(nodos_frontera):
                nodos_frontera.append(hijo_izquierdo)
                
            hijo = [dato_nodo[0], dato_nodo[2], dato_nodo[1], dato_nodo[3], dato_nodo[4], dato_nodo[5], dato_nodo[6]]
            ...
            hijo = [dato_nodo[0], dato_nodo[1], dato_nodo[3], dato_nodo[2], dato_nodo[4], dato_nodo[5], dato_nodo[6]]
            ...
            hijo = [dato_nodo[0], dato_nodo[1], dato_nodo[2], dato_nodo[4], dato_nodo[3], dato_nodo[5], dato_nodo[6]]
            ...
            hijo = [dato_nodo[0], dato_nodo[1], dato_nodo[2], dato_nodo[3], dato_nodo[5], dato_nodo[4], dato_nodo[6]]
            ...
            hijo = [dato_nodo[0], dato_nodo[1], dato_nodo[2], dato_nodo[3], dato_nodo[4], dato_nodo[6], dato_nodo[5]]
...
#                nodos_frontera.append(hijo_izquierdo7)
            ...
            nodo.set_hijos([hijo_izquierdo, hijo_izquierdo2, hijo_izquierdo3,hijo_izquierdo4,hijo_izquierdo5,hijo_izquierdo6])
